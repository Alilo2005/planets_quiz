    ...
    <div className="relative w-full max-w-4xl mx-auto p-6 md:p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl">
      <div className="grid md:grid-cols-[220px,1fr] gap-6 items-center">
        <div className="relative h-48 md:h-56">
          ...
          >
            <div className="relative h-40 w-40 md:h-48 md:w-48 rounded-full bg-gradient-to-tr from-fuchsia-500/40 via-sky-400/40 to-violet-500/40 shadow-[0_0_80px_rgba(168,85,247,0.35)]">
              <motion.div
        ...
        <div>
          <h2 className="text-3xl md:text-4xl font-serif text-white mb-2">{planet.name}</h2>
