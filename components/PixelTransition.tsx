...
interface PixelTransitionProps {
  ...
  style?: CSSProperties;
  aspectRatio?: string;
  unstyled?: boolean; // if true, omit default card styling
  fitParent?: boolean; // if true, fill parent size and skip aspect spacer
}
...
const PixelTransition: React.FC<PixelTransitionProps> = ({
  ...
  const baseClasses = unstyled
    ...
    : 'relative overflow-hidden bg-[#222] text-white rounded-[15px] border-2 border-white w-[300px] max-w-full';
  ...
  return (
    ...
    >
      {!fitParent && <div style={{ paddingTop: aspectRatio }} />}
