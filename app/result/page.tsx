...
export default function ResultPage() {
  ...
  <h1 className="text-3xl md:text-5xl font-cosmic text-white text-center">Your Cosmic Match</h1>
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        <CosmicButton onClick={share}>Share Result</CosmicButton>
      </div>
      <p className="text-center text-silver pt-4">Your cosmic essence has been revealed. Share your planet with the universe.</p>
      {shared && <p className="text-center text-sky-200/90">{shared}</p>}
    </div>
  );
}
